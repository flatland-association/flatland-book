...
| Policy              | Recevies an observation for each agent and outputs an action for each agent. The policy may consist of a single sub-policy applied to each agent unilaterally or it may have different sub-policies for each agent individually. |
...
| Rewards             | A reward for each agent.  Also used for the component building the rewards during `step`.                                                                                                                                        |
...
| Rail (Generator)      | Outputs a transition map and stopping points.                                                                                                                                                                                                                              |
...
| City                  | In sparse rail generator, internally used alias for stations.                                                                                                                                                                                                              |
