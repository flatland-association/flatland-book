...
All 28 stations are provided for participants in [*stations.pkl*](reinforcement_learning/sampling/stations.pkl). 6 lines that are used in the evaliation are also given as examples in [*level_0_scenario_1.pkl*](reinforcement_learning/sampling/level_0_scenario_1.pkl).
